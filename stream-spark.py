...
st.title("Procesamiento de datos con spark y streamlit")

st.header("by Gerardo Deustua Hernandez")

github_user  =  st.text_input('Github user', value='GerryDH2807')
github_repo  =  st.text_input('Github repo', value='RetoSparkStreamPython')
